...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal" data-topbar="colored"> -->
       ...
       <?php echo view('menu');?>    <!-- Sidebar -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <?php if(isset ($ajout)) echo $ajout->listErrors()?>
                                                ...
                                                <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal">diplome</button>
                                                <!-- sample modal content -->
                                                <form action="<?php echo base_url("rh/diplome")?>" method="post">
                                                <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title mt-0" id="myModalLabel">diplome</h5>
          ...
          <tr id="<?php echo $user['id']; ?>"> 
             ...
             <button type="button" class="btn btn-primary waves-effect waves-light edit" data-bs-toggle="modal" data-bs-target="#idModal">update</button>
                                                <!-- sample modal content -->
                                               </td>
         ...
         <?php endif; ?>
                                        ...
                                        <form action="<?php echo base_url("rh/diplomeup")?>" method="post">
        ...
        {
            $.ajax({
               url: "<?php echo base_url('/rh/diplome/').'/'?>"+id,
               type: 'POST',
               error: function() {
    ...
    <script type="text/javascript">
        ...
        var id = $(this).parents("tr").attr("id");
            ...
            $.ajax({
               url: "<?php echo base_url('/rh/diplomeget/').'/'?>"+id,
               type: 'POST',
               error: function() {
                  alert('Something is wrong');
               },
